Shader "Scream2024/NoiseGenWeb/Chamber"
{
    Properties
    {
        ...
        [PerRendererData] _ChamberR("_ChamberR", Float) = 24
        [PerRendererData] _ChamberOblX("_ChamberOblX", Float) = 1
        [PerRendererData] _ChamberOblZ("_ChamberOblZ", Float) = 1
        [PerRendererData] _ChamberWeight("_ChamberWeight", Float) = 1
        [PerRendererData]_NoiseWeight("_NoiseWeight", Float) = 1
        [PerRendererData]_CeilHardness("_CeilHardness", Float) = 1
        [PerRendererData]_FloorHardness("_FloorHardness", Float) = 1
        [PerRendererData]_WallHardness("_WallHardness", Float) = 1
