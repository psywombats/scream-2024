...
if not getSwitch('d3_04_control') then
	speak('CONTROL', "I'm sick of everyone arguing, and I'm sick of sitting around up here tinkering with Chasm.")
	...
	speak('CONTROL', "Like, the cave that Chasm spits out is total nonsense. The chambers overlap with each other. It's way too deep. It's non-Euclidean garbage and feeding to to Chasm generates glitchy nightmare hellscapes.")
	expr('CONTROL', '')
