...
radio('CONTROL', "Hellooo? Anyone read me?")
radio('YOU', "Nika! It's Phoebe! Everyting's falling apart down here.")
radio('CONTROL', "I figured. That's why I decided to come in person. Tom and Jeanne ditched you, huh?")
...
radio('CONTROL', "Like I said, I decided I'd come in person. You're entirely within Spelonky's simulation right now, so I figure I'd just patch myself in.")
radio('YOU', "But the repeater's range shouldn't...")
radio('CONTROL', "Nah, I'm close enough to radio you normally. I think I'm about 1800 meters down? Don't worry, I'll be there soon.")
radio('CONTROL', "And don't worry about Jeanne's body. That was just her from the previous meta level. Once you reach the bottom, you'll be able to follow her out of the simulation too.")
radio('YOU', "Nika, where are you? I'm going to head your way, okay?")
radio('CONTROL', "Just head to the bottom and we'll chat there. Sound good?")
radio('YOU', "No!")
radio('CONTROL', "Looks, there's some pretty technical abseiling here, so I've got to jump off for now. See you soon!")
exitRadio()
